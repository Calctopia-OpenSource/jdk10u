...
typedef struct { OblivBit bits[__bitsize(int)]; } __obliv_c__float;

typedef __obliv_c__int oint;
//typedef __obliv_c__long olong;
typedef __obliv_c__lLong olong;
typedef __obliv_c__int ofloat32;
typedef __obliv_c__lLong ofloat64;
typedef __obliv_c__bool oflag;
typedef __obliv_c__char ochar;
typedef __obliv_c__short oshort;
typedef __obliv_c__char* ostring;

// Just a cast
static inline OblivBit* __obliv_c__bits(void* x) { return (OblivBit*) x; }
